...
const MediaPage3 = ({
  ...
  <Card className="animated fadeIn">
    <CardHeader>
      <h4>
        <strong>Social Media Submission - 3 of 3</strong>
      </h4>
    </CardHeader>
    <CardBody>
      <p>
        If you have a specific tweet, social media post, important info or
        hashtags to use, please include them below. Otherwise we will create a
        post based on the information provided.
      </p>
